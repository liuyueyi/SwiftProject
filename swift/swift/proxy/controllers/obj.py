...
class ObjectController(Controller):
	...
	object_info = resp.headers
	req.attr_policy = object_info['x-object-meta-attr-policy']

	#if self.self.object_name:
	#objcet_info = self.object_info(self.account_name, self.container_name, self.object_name, req)
	    #logging.info(objcet_info)
	#logging.info(object_info['X-Object-Meta-Attr-Policy'])
	#req.attr_policy = object_info['X-Object-Meta-Attr-Policy']
