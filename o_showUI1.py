...
#
# Created: Fri Jan  3 17:21:57 2014
...
class Ui_showWindow(object):
    def setupUi(self, showWindow):
        ...
        showWindow.resize(434, 749)
        self.tabWidget = QtGui.QTabWidget(showWindow)
        self.tabWidget.setGeometry(QtCore.QRect(0, 10, 431, 731))
        ...
        self.downloadTable.setColumnCount(4)
    ...
    def retranslateUi(self, showWindow):
        showWindow.setWindowTitle(_translate("showWindow", "上传下载界面", None))
        self.checkBox.setText(_translate("showWindow", "全选", None))
        self.encryptCheckBox.setText(_translate("showWindow", "加密", None))
        self.auditCheckBox.setText(_translate("showWindow", "审计", None))
        self.startButton.setText(_translate("showWindow", "Start", None))
        self.deleteButton.setText(_translate("showWindow", "删除", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("showWindow", "上传", None))
        self.deleteButton2.setText(_translate("showWindow", "删除", None))
        self.checkBox2.setText(_translate("showWindow", "全选", None))
        self.startButton2.setText(_translate("showWindow", "Start", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("showWindow", "下载", None))
