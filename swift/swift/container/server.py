...
class ContainerController(object):
	...
	#logging.basicConfig(filename="/home/ceph-w/swift/swift/container/log", level=#logging.info)
	...
	#logging.info("...account server delete...")
	...
	#logging.info("...account server put...")
        drive, part, account, container, obj = split_and_validate_path(
            req, 4, 5, True)
        if 'x-timestamp' not in req.headers or \
                not check_float(req.headers['x-timestamp']):
	...
	#logging.info("...account server head...")
        drive, part, account, container, obj = split_and_validate_path(
            req, 4, 5, True)
    ...
    def update_data_record(self, record):
        ...
        """
	#logging.info("...account server update_data_record...")
	...
	#logging.info("...account server get...")
        drive, part, account, container, obj = split_and_validate_path(
            req, 4, 5, True)
	...
	#logging.info("...account server post...")
