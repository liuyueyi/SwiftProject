...
#
# Created: Thu Feb 27 17:11:19 2014
...
class Ui_loginForm(object):
    ...
    def retranslateUi(self, loginForm):
        ...
        self.usernameEdit.setText(_translate("loginForm", "test:tester", None))
        self.passwordEdit.setText(_translate("loginForm", "testing", None))
        self.loginButton.setText(_translate("loginForm", "登陆", None))
        self.label.setText(_translate("loginForm", "用户名：", None))
        self.label_2.setText(_translate("loginForm", "密码：", None))
        self.label_3.setText(_translate("loginForm", "登陆窗口", None))
        self.registButton.setText(_translate("loginForm", "注册", None))
        self.label_4.setText(_translate("loginForm", "还没有帐号，点击右边按钮快速注册", None))
